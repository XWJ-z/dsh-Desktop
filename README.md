...
<a href="https://github.com/XWJ-z/dsh-Desktop/releases/download/v2.1.2/DSH-Desktop-Setup-2.1.2.exe">
<img src="https://img.shields.io/badge/下载安装包-DSH--Desktop--Setup--2.1.2.exe%20%E7%BA%A6115MB-2ea44f?style=for-the-badge&logo=windows&logoColor=white" alt="下载 DSH-Desktop 安装包"/>
</a>
...
| v2.1.2 | 修复旧版本覆盖安装新版后打不开（DSH 内核低于可运行版本自动升级到最新）+ DSH 升级后自动清理旧版本缓存残留 |
