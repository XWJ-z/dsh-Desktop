...
| v0.8.x | v0.8 长期功能线（内部迭代中，正式发布后 0.8.10 为该线最终版）|

---

## ✍️ 项目署名规范（zx 统一格式）

> 团队统一署名格式：**`zx(身份标识)`**（2026-08-16 起执行）。凡需要署名的地方——代码注释、文档、release_notes、开发日志、版本信息等——一律使用该格式，**不单独写** `zx` / `开发助手-6` / `6` 等。
